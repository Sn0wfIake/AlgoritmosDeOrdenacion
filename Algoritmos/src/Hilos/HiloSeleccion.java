...
public class HiloSeleccion extends Thread {
	...
	public void run() {
		...
		this.panel.getComponent(0).setBackground(Color.green);
	}
	...
	public void swap(int[] array, int a, int b) {
		...
		if (a != b) {
			this.panel.getComponent(b).setBackground(Color.green);
			this.panel.getComponent(a).setBackground(Color.green);
		} else
			this.panel.getComponent(b).setBackground(Color.green);
	}
}
